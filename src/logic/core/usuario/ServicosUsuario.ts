import Autenticacao, { CancelarObservacao, ObservadorUsuario } from "../../firebase/auth/Autenticacao"
...
export default class ServicosUsuario {
    ...
    monitorarAutenticacao(observador: ObservadorUsuario): CancelarObservacao {
